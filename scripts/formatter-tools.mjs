    ...
    JSON.stringify(
      {
        ...
        identifierReferences: index.identifierReferences.length,
        inferredTypes: index.inferredTypes.length,
        unusedResources: index.graph.unusedResources.length,
        resourceTypeMismatches: index.graph.resourceTypeMismatches,
        missingLayerReferences: index.graph.missingLayerReferences,
